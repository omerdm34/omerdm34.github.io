...
const en = {
  ...
  nav: { departures: 'Departures', projects: 'Projects', beyond: 'Beyond code', notes: 'Log', contact: 'Contact' },
...
const tr: Content = {
  ...
  nav: { departures: 'Kalkışlar', projects: 'Projeler', beyond: 'Kod dışında', notes: 'Günlük', contact: 'İletişim' },
